...
public class AlisverisListesi : MonoBehaviour
{
    ...
    private IEnumerator LoadShowingImages()
    {
        ...
        Sprite shelfImage = Resources.Load<Sprite>("shelf");
        shelf.GetComponent<Image>().sprite = shelfImage;
    ...
    private IEnumerator ReadyToStart()
    {
        ...
        countdownDisplay.text = "Listedeki ürünleri sepete koyalım";
        yield return new WaitForSeconds(1.0f);
    ...
    private void CreateOptions(int numberOfElements)
    {
        ...
        {
            options.transform.localPosition = new Vector2(0, 325);
            optionsGridLayoutGroup.cellSize = new Vector2(150, 150);
            optionsGridLayoutGroup.spacing = new Vector2(100, 50);
        }
        if (numberOfElements >= 6)
        {
            options.transform.localPosition = new Vector2(0, 325);
            optionsGridLayoutGroup.cellSize = new Vector2(150, 150);
            optionsGridLayoutGroup.spacing = new Vector2(100, 60);
        }
        if (numberOfElements >= 8)
        {
            options.transform.localPosition = new Vector2(0, 200);
            optionsGridLayoutGroup.cellSize = new Vector2(150, 150);
    ...
    private void CheckSuccessRate(bool isSucces)
    {
        ...
        } else
        {
            if (isSucces)
            {
                ...
                succedDialogText.text = "Doğru ürünleri aldınız!";
                succedDialog.SetActive(true);
    ...
    private IEnumerator CountdownToStart()
    {
        ...
        countdownDisplay.text = "AlışverişSepeti oyununa hoşgeldiniz!";
        yield return new WaitForSeconds(1.0f);
        countdownDisplay.text = "Alışveriş başlasın!";
        yield return new WaitForSeconds(1.0f);
